...
class RFlowScheduler:
    ...
    def training_losses(
        ...
        """
        # print("losslosslosslosslosslosslosslosslosslosslosslossloss")
        # print(x_start.shape)
        y_null = None
        # print((mask_index))
        ...
        batch_indices = torch.arange(batch_size, device=x_start.device)
        # x_t = self.add_noise(x_start, noise, t)
        # t = 15-t
        x_t_f = x_start[batch_indices,:,t-1,...]
        x_t = x_start[batch_indices,:,t,...]
        x_pre_t = x_pre[batch_indices,:,t,...]
        # if mask is not None:
